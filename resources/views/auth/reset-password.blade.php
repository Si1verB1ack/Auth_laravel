				...
				<div class="col-12">
					<div class="sign__content">
						...
						<form action="{{route('password.update')}}"  class="sign__form" method="POST">
                            ...
                            @endif
                            <input type="hidden" class="sign__input" placeholder="Email" name="token" value="{{request()->route('token')}}">
							<div class="sign__group">
								<input type="text" readonly class="sign__input" placeholder="Email" name="email" value="{{ request()->email}}">
							</div>
                            @error('email')
                            ...
                            <div class="sign__group">
								<input type="password" class="sign__input" placeholder="Re-Password" name="password_confirmation">
							</div>
