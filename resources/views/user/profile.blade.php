                ...
                <div class="profile__content">
                    ...
                    <div class="profile__user">
                        ...
                        <div class="profile__meta profile__meta--green">
                            <h3>{{ Auth::user()->name }} <span>{{ Auth::user()->status ? '(Approved)' : '(Block)' }}</span>
                            </h3>
                            <span>FlixTV ID: {{ number_format(Auth::user()->id) }}</span>
                        </div>
                    </div>
                    <!-- end profile user -->
                        ...
                        <div class="profile__mobile-tabs-menu dropdown-menu" aria-labelledby="mobile-tabs">
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li class="nav-item"><a class="nav-link" id="2-tab" data-toggle="tab" href="#tab-2"
                                        role="tab" aria-controls="tab-2" aria-selected="false">Comments</a></li>
