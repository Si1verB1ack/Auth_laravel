...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar__user">
            ...
            <form action="{{ route('logout') }}" method="POST" class="sidebar__user-btn">
                @csrf
        ...
        <ul class="sidebar__nav">
            <li class="sidebar__nav-item">
                <a href="index.html" class="sidebar__nav-link sidebar__nav-link--active"><svg
                    ...
                    </svg> <span>ទំព័រដើម</span></a>
            </li>

            <li class="sidebar__nav-item">
                <a href="catalog.html" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path
            ...
            <li class="sidebar__nav-item">
                <a href="users.html" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path
            ...
            <li class="sidebar__nav-item">
                <a href="comments.html" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path
            ...
            <li class="sidebar__nav-item">
                <a href="reviews.html" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path
            ...
            <li class="sidebar__nav-item">
                <a href="../main/index.html" class="sidebar__nav-link"><svg xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                        <path
